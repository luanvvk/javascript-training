...
export default class TaskFormController {
  ...
  handleAddTaskButtonClick() {
    if (!this.modalView) {
      console.error('ModalView not available in handleAddTaskButtonClick');
      return;
    }

    const modalElement = document.getElementById('create-task-modal');
    if (!modalElement) {
      console.error('Create task modal element not found in DOM');
      return;
    }
